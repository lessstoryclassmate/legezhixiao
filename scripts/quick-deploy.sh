...
# MySQL 配置 (云数据库) - 适配清理后的配置
DATABASE_USER=${DATABASE_USER:-novel_user}
DATABASE_PASSWORD=${DATABASE_PASSWORD:-defaultpass123}
DATABASE_SYSTEMHOST=${DATABASE_SYSTEMHOST:-mysql-system}
DATABASE_SYSTEM=${DATABASE_SYSTEM:-novel_system_db}
...
DATABASE_NOVELHOST=${DATABASE_NOVELHOST:-mysql-user}
DATABASE_NOVELDATA=${DATABASE_NOVELDATA:-novel_content_db}
